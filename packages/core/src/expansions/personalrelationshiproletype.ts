 ...
 */
export const PersonalRelationshipRoleTypeCode = {
  /**
   * family member
   */
  FAMMEMB: "FAMMEMB",
 ...
 */
export type PersonalRelationshipRoleTypeCode =
  typeof PersonalRelationshipRoleTypeCode[keyof typeof PersonalRelationshipRoleTypeCode];
