 ...
 */
export const ActAdministrativeDetectedIssueCodeCode = {
  /**
 ...
 */
export type ActAdministrativeDetectedIssueCodeCode =
  typeof ActAdministrativeDetectedIssueCodeCode[keyof typeof ActAdministrativeDetectedIssueCodeCode];
