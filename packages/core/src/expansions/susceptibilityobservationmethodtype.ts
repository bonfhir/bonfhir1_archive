/**
 * **Description:**Test methods designed to determine a microorganismâ€™s susceptibility to an antibiotic.
 * http://terminology.hl7.org/ValueSet/v3-SusceptibilityObservationMethodType
 */
export const SusceptibilityObservationMethodTypeCode = {
  /**
   * DecisionObservationMethod
   */
  _DecisionObservationMethod: "_DecisionObservationMethod",
  ...
  /**
   * allergy test observation
   */
  _AllergyTestObservationMethod: "_AllergyTestObservationMethod",

  /**
   * common clinical observation
   */
  _CommonClinicalObservationMethod: "_CommonClinicalObservationMethod",
 ...
 */
export type SusceptibilityObservationMethodTypeCode =
  typeof SusceptibilityObservationMethodTypeCode[keyof typeof SusceptibilityObservationMethodTypeCode];
