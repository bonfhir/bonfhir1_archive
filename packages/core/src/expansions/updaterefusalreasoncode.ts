/**
 * ***No description***
 * http://terminology.hl7.org/ValueSet/v3-UpdateRefusalReasonCode
 */
export const UpdateRefusalReasonCodeCode = {
  /**
   * RefusalReasonCode
   */
 ...
 */
export type UpdateRefusalReasonCodeCode =
  typeof UpdateRefusalReasonCodeCode[keyof typeof UpdateRefusalReasonCodeCode];
