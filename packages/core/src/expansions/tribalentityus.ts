 ...
 */
export const TribalEntityUSCode = {
  /**
   ...
   * NativeEntityAlaska
   */
  _NativeEntityAlaska: "_NativeEntityAlaska",

  /**
   * NativeEntityContiguous
   */
  _NativeEntityContiguous: "_NativeEntityContiguous",
} as const;

/**
 * https://hl7.org/fhir/valueset-address-type.html
 */
export type TribalEntityUSCode =
  typeof TribalEntityUSCode[keyof typeof TribalEntityUSCode];
