...
export const TestScriptRequestMethodCodeCodeSystem = {
  ...
  content: "complete",
  concept: [
    { code: "delete", display: "DELETE", definition: "HTTP DELETE operation." },
    { code: "get", display: "GET", definition: "HTTP GET operation." },
    {
      code: "options",
      display: "OPTIONS",
      definition: "HTTP OPTIONS operation.",
    },
    { code: "patch", display: "PATCH", definition: "HTTP PATCH operation." },
    { code: "post", display: "POST", definition: "HTTP POST operation." },
    { code: "put", display: "PUT", definition: "HTTP PUT operation." },
    { code: "head", display: "HEAD", definition: "HTTP HEAD operation." },
  ],
};
