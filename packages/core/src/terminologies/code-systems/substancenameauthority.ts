...
export const SubstanceNameAuthorityCodeSystem = {
  ...
  identifier: [
    {
      ...
      value: "urn:oid:2.16.840.1.113883.4.642.1.1637",
    },
  ],
  version: "4.3.0",
  ...
  content: "complete",
  concept: [
    { code: "BAN", display: "BAN" },
    { code: "COSING", display: "COSING" },
    { code: "Ph.Eur.", display: "Ph.Eur." },
    { code: "FCC", display: "FCC" },
    { code: "INCI", display: "INCI" },
    { code: "INN", display: "INN" },
    { code: "JAN", display: "JAN" },
    { code: "JECFA", display: "JECFA" },
    { code: "MARTINDALE", display: "MARTINDALE" },
    { code: "USAN", display: "USAN" },
    { code: "USP", display: "USP" },
    { code: "PHF", display: "PHF" },
    { code: "HAB", display: "HAB" },
    { code: "PhF", display: "PhF (Pharmacopée française)" },
    { code: "IUIS", display: "IUIS" },
  ],
};
