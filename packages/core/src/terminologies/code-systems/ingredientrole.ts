...
export const IngredientRoleCodeSystem = {
  ...
  identifier: [
    {
      ...
      value: "urn:oid:2.16.840.1.113883.4.642.1.1595",
    },
  ],
  version: "4.3.0",
  name: "IngredientRole",
  ...
  content: "complete",
  concept: [
    { code: "100000072072", display: "Active" },
    { code: "100000072073", display: "Adjuvant" },
    { code: "100000072082", display: "Excipient" },
    { code: "100000136065", display: "Starting material for excipient" },
    { code: "100000136066", display: "Solvent / Diluent" },
    {
      code: "100000136178",
      display: "Raw materials used in the manufacture of the product",
    },
    { code: "100000136179", display: "Starting material for active substance" },
    { code: "100000136561", display: "Overage" },
    { code: "200000003427", display: "bioenhancer" },
  ],
};
