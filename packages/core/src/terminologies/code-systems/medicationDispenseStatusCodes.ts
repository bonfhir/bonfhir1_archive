 ...
 */
export const MedicationDispenseStatusCodesCodeSystem = {
  ...
  identifier: [
    {
      ...
      value: "urn:oid:2.16.840.1.113883.4.642.1.1313",
    },
  ],
  version: "4.3.0",
  name: "Medication Dispense Status Codes",
  status: "draft",
  experimental: false,
  caseSensitive: true,
