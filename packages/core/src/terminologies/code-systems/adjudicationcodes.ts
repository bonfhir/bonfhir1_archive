export const AdjudicationCodes = {
  ...
  concept: [
    ...
    { code: "copay", display: "CoPay", definition: "Patient Co-Payment" },
    {
      code: "eligible",
    ...
    { code: "tax", display: "Tax", definition: "The amount of tax." },
    {
      code: "benefit",
