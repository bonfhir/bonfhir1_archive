...
export const ICD10ProcedureCodesCodeSystem = {
  ...
  content: "complete",
  concept: [
    { code: "123001", display: "PROC-1", definition: "Procedure 1" },
    { code: "123002", display: "PROC-2", definition: "Procedure 2" },
    { code: "123003", display: "PROC-3", definition: "Procedure 3" },
  ],
};
