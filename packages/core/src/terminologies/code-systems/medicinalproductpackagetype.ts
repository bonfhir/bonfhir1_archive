export const MedicinalProductPackageType = {
  ...
  identifier: [
    {
      ...
      value: "urn:oid:2.16.840.1.113883.4.642.1.1552",
    },
  ],
  version: "4.3.0",
  ...
  content: "complete",
  concept: [
    { code: "100000073490", display: "Ampoule" },
    { code: "100000073491", display: "Applicator" },
    { code: "100000073492", display: "Automatic injection device" },
    { code: "100000073493", display: "Bag" },
    { code: "100000073494", display: "Balling gun" },
    { code: "100000073495", display: "Barrel" },
    { code: "100000073496", display: "Blister" },
    { code: "100000073497", display: "Bottle" },
    { code: "100000073498", display: "Box" },
    { code: "100000073547", display: "Sachet" },
    { code: "100000073563", display: "Vial" },
    { code: "100000143555", display: "Pack" },
  ],
};
