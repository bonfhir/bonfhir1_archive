 ...
 */
export const CitedArtifactClassificationTypeCodeSystem = {
  ...
  concept: [
    ...
    { code: "keyword", display: "Keyword", definition: "Keyword" },
    {
      code: "citation-subset",
      display: "Citation subset",
      definition: "Citation subset",
    },
    { code: "chemical", display: "Chemical", definition: "Chemical" },
    {
