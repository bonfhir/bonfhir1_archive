...
export const FHIRDeviceStatusReasonCodeSystem = {
  ...
  content: "complete",
  concept: [
    { code: "online", display: "Online", definition: "The device is off." },
    { code: "paused", display: "Paused", definition: "The device is paused." },
    {
      code: "standby",
      display: "Standby",
    ...
    { code: "off", display: "Off", definition: "The device is off." },
  ],
};
