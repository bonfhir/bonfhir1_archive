export const ObservationDataType = {
  ...
  identifier: [
    {
      ...
      value: "urn:oid:2.16.840.1.113883.4.642.4.1332",
    },
  ],
  version: "4.3.0",
  ...
  content: "complete",
  concept: [
    { code: "Quantity", display: "Quantity", definition: "A measured amount." },
    {
    ...
    { code: "boolean", display: "boolean", definition: "true or false." },
    { code: "integer", display: "integer", definition: "A signed integer." },
    {
      code: "Range",
      display: "Range",
