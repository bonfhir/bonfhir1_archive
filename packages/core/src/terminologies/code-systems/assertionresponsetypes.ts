...
export const AssertionResponseTypesCodeSystem = {
  ...
  content: "complete",
  concept: [
    { code: "okay", display: "okay", definition: "Response code is 200." },
    {
      code: "created",
      display: "created",
    ...
    { code: "bad", display: "bad", definition: "Response code is 400." },
    {
      code: "forbidden",
      display: "forbidden",
    ...
    { code: "gone", display: "gone", definition: "Response code is 410." },
    {
