 ...
 */
export const MedicationKnowledgePackageTypeCodesCodeSystem = {
  ...
  content: "complete",
  concept: [
    { code: "amp", display: "Ampule" },
    { code: "bag", display: "Bag" },
    { code: "blstrpk", display: "Blister Pack" },
    { code: "bot", display: "Bottle" },
    { code: "box", display: "Box" },
    { code: "can", display: "Can" },
    { code: "cart", display: "Cartridge" },
    { code: "disk", display: "Disk" },
    { code: "doset", display: "Dosette" },
    { code: "jar", display: "Jar" },
    { code: "jug", display: "Jug" },
    { code: "minim", display: "Minim" },
    { code: "nebamp", display: "Nebule Amp" },
    { code: "ovul", display: "Ovule" },
    { code: "pch", display: "Pouch" },
    { code: "pkt", display: "Packet" },
    { code: "sash", display: "Sashet" },
    { code: "strip", display: "Strip" },
    { code: "tin", display: "Tin" },
    { code: "tub", display: "Tub" },
    { code: "tube", display: "Tube" },
