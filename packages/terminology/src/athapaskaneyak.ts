/**
 * ***No description***
 * http://terminology.hl7.org/ValueSet/v3-AthapaskanEyak
 */
export const AthapaskanEyakCode = {
  /**
   * Athapaskan
   */
 ...
 */
export type AthapaskanEyakCode =
  typeof AthapaskanEyakCode[keyof typeof AthapaskanEyakCode];
