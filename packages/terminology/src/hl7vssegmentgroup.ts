 ...
 * http://terminology.hl7.org/ValueSet/v2-0391
 */
export const Hl7VSSegmentGroupCode = {
  /**
   * PID group
   */
  PIDgroup: "PIDG",
 ...
 */
export type Hl7VSSegmentGroupCode =
  typeof Hl7VSSegmentGroupCode[keyof typeof Hl7VSSegmentGroupCode];
