 ...
 * http://terminology.hl7.org/ValueSet/v3-CountryEntityType
 */
export const CountryEntityTypeCode = {
  /**
   * Andorra
   */
  Andorra: "AD",
 ...
 */
export type CountryEntityTypeCode =
  typeof CountryEntityTypeCode[keyof typeof CountryEntityTypeCode];
