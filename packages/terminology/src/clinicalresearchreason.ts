 ...
 * http://terminology.hl7.org/ValueSet/v3-ClinicalResearchReason
 */
export const ClinicalResearchReasonCode = {
  /**
   * retest
   */
  retest: "RET",
 ...
 */
export type ClinicalResearchReasonCode =
  typeof ClinicalResearchReasonCode[keyof typeof ClinicalResearchReasonCode];
