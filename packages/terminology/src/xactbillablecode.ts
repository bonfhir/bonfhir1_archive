/**
 * ***No description***
 * http://terminology.hl7.org/ValueSet/v3-xActBillableCode
 */
export const XActBillableCodeCode = {
  /**
   * ambulatory
   */
  AMB: "AMB",
 ...
 */
export type XActBillableCodeCode =
  typeof XActBillableCodeCode[keyof typeof XActBillableCodeCode];
