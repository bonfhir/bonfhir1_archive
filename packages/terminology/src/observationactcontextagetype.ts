 ...
 */
export const ObservationActContextAgeTypeCode = {
  /**
   * age patient qn est
   */
 ...
 */
export type ObservationActContextAgeTypeCode =
  typeof ObservationActContextAgeTypeCode[keyof typeof ObservationActContextAgeTypeCode];
