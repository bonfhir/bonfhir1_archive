 ...
 */
export const MedicationOrderAbortReasonCodeCode = {
  /**
 ...
 */
export type MedicationOrderAbortReasonCodeCode =
  typeof MedicationOrderAbortReasonCodeCode[keyof typeof MedicationOrderAbortReasonCodeCode];
