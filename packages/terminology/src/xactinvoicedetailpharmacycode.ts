 ...
 */
export const XActInvoiceDetailPharmacyCodeCode = {
  /**
 ...
 */
export type XActInvoiceDetailPharmacyCodeCode =
  typeof XActInvoiceDetailPharmacyCodeCode[keyof typeof XActInvoiceDetailPharmacyCodeCode];
