...
export const SusceptibilityObservationMethodTypeCode = {
   ...
   */
  DecisionObservationMethod: "_DecisionObservationMethod",
   ...
   */
  allergytestobservation: "_AllergyTestObservationMethod",

  /**
   * common clinical observation
   */
  commonclinicalobservation: "_CommonClinicalObservationMethod",
