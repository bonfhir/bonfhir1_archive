/**
 * A â€˜personal and legalâ€™ relationship records the role of a person in relation to another person, or a person to himself or herself. This value set is to be used when recording relationships based on personal or family ties or through legal assignment of responsibility.
 * http://terminology.hl7.org/ValueSet/v3-PersonalAndLegalRelationshipRoleType
 */
export const PersonalAndLegalRelationshipRoleTypeCode = {
  /**
   * family member
   */
  FAMMEMB: "FAMMEMB",
 ...
 */
export type PersonalAndLegalRelationshipRoleTypeCode =
  typeof PersonalAndLegalRelationshipRoleTypeCode[keyof typeof PersonalAndLegalRelationshipRoleTypeCode];
