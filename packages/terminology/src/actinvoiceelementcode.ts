 ...
 * http://terminology.hl7.org/ValueSet/v3-ActInvoiceElementCode
 */
export const ActInvoiceElementCodeCode = {
  /**
 ...
 */
export type ActInvoiceElementCodeCode =
  typeof ActInvoiceElementCodeCode[keyof typeof ActInvoiceElementCodeCode];
