 ...
 * http://terminology.hl7.org/ValueSet/v3-DedicatedServiceDeliveryLocationRoleType
 */
export const DedicatedServiceDeliveryLocationRoleTypeCode = {
  /**
 ...
 */
export type DedicatedServiceDeliveryLocationRoleTypeCode =
  typeof DedicatedServiceDeliveryLocationRoleTypeCode[keyof typeof DedicatedServiceDeliveryLocationRoleTypeCode];
