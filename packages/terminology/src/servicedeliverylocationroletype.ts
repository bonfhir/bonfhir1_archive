 ...
 */
export const ServiceDeliveryLocationRoleTypeCode = {
  /**
 ...
 */
export type ServiceDeliveryLocationRoleTypeCode =
  typeof ServiceDeliveryLocationRoleTypeCode[keyof typeof ServiceDeliveryLocationRoleTypeCode];
