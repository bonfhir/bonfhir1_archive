/**
 * ***No description***
 * http://terminology.hl7.org/ValueSet/v3-RefusalReasonCode
 */
export const RefusalReasonCodeCode = {
  /**
   * RefusalReasonCode
   */
 ...
 */
export type RefusalReasonCodeCode =
  typeof RefusalReasonCodeCode[keyof typeof RefusalReasonCodeCode];
